...
![5.1 集中式工作流](../../../../raw/master/figures/18333fig0501-tn.png "5.1 集中式工作流")
...
![5.2 集成管理员工作流](../../../../raw/master/figures/18333fig0502-tn.png "5.2 集成管理员工作流")
...
![5.3 司令官与副官工作流](../../../../raw/master/figures/18333fig0503-tn.png "5.3 司令官与副官工作流")
...
![5.4 John 的仓库历史](../../../../raw/master/figures/18333fig0504-tn.png "5.4 John 的仓库历史")
...
![5.5 合并 origin/master 后 John 的仓库历史](../../../../raw/master/figures/18333fig0505-tn.png "5.5 合并 origin/master 后 John 的仓库历史")
...
![5.6 推送后 John 的仓库历史](../../../../raw/master/figures/18333fig0506-tn.png "5.6 推送后 John 的仓库历史")

图 5-6. 推送后 John 的仓库历史

而在这段时间，Jessica 已经开始在另一个特性分支工作了。她创建了 `issue54` 并提交了三次更新。她还没有下载 John 提交的合并结果，所以提交历史如图 5-7 所示：

![5.7 Jessica 的提交历史](../../../../raw/master/figures/18333fig0507-tn.png "5.7 Jessica 的提交历史")
...
![5.8 获取 John 的更新之后 Jessica 的提交历史](../../../../raw/master/figures/18333fig0508-tn.png "5.8 获取 John 的更新之后 Jessica 的提交历史")
...
![5.9 合并 John 的更新后 Jessica 的提交历史](../../../../raw/master/figures/18333fig0509-tn.png "5.9 合并 John 的更新后 Jessica 的提交历史")
...
![5.10 Jessica 推送数据后的提交历史](../../../../raw/master/figures/18333fig0510-tn.png "5.10 Jessica 推送数据后的提交历史")
...
![5.11 多用户共享仓库协作方式的一般工作流程时序](../../../../raw/master/figures/18333fig0511-tn.png "5.11 多用户共享仓库协作方式的一般工作流程时序")
...
![5.12 Jessica 的更新历史](../../../../raw/master/figures/18333fig0512-tn.png "5.12 Jessica 的更新历史")
...
![5.13 在特性分支中提交更新后的提交历史](../../../../raw/master/figures/18333fig0513-tn.png "5.13 在特性分支中提交更新后的提交历史")
...
![5.14 合并特性分支后的 Jessica 提交历史](../../../../raw/master/figures/18333fig0514-tn.png "5.14 合并特性分支后的 Jessica 提交历史")
...
![5.15 团队间协作工作流程基本时序](../../../../raw/master/figures/18333fig0515-tn.png "5.15 团队间协作工作流程基本时序")
...
![5.16 featureB 以后的提交历史](../../../../raw/master/figures/18333fig0516-tn.png "5.16 featureB 以后的提交历史")
...
![5.17 featureA 重新衍合后的提交历史](../../../../raw/master/figures/18333fig0517-tn.png "5.17 featureA 重新衍合后的提交历史")
...
![5.18 featureBv2 之后的提交历史](../../../../raw/master/figures/18333fig0518-tn.png "5.18 featureBv2 之后的提交历史")
...
![5.19 多个特性分支](../../../../raw/master/figures/18333fig0519-tn.png "5.19 多个特性分支")

图 5-19. 多个特性分支

![5.20 合并特性分支之后](../../../../raw/master/figures/18333fig0520-tn.png "5.20 合并特性分支之后")
...
![5.21 特性分支合并前](../../../../raw/master/figures/18333fig0521-tn.png "5.21 特性分支合并前")

图 5-21. 特性分支合并前

![5.22 特性分支合并后](../../../../raw/master/figures/18333fig0522-tn.png "5.22 特性分支合并后")

图 5-22. 特性分支合并后

![5.23 特性分支发布后](../../../../raw/master/figures/18333fig0523-tn.png "5.23 特性分支发布后")
...
![5.24 管理复杂的并行贡献](../../../../raw/master/figures/18333fig0524-tn.png "5.24 管理复杂的并行贡献")
...
![5.25 将特性并入长期分支](../../../../raw/master/figures/18333fig0525-tn.png "5.25 将特性并入长期分支")
...
![5.26 挑拣（cherry-pick）之前的历史 ](../../../../raw/master/figures/18333fig0526-tn.png "5.26 挑拣（cherry-pick）之前的历史 ")
...
![5.27 挑拣（cherry-pick）之后的历史](../../../../raw/master/figures/18333fig0527-tn.png "5.27 挑拣（cherry-pick）之后的历史")
